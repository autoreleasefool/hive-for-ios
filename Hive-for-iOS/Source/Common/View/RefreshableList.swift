...
struct RefreshableList<Content: View>: View {
	...
	public var body: some View {
		RefreshableListInternal(showRefreshView: $showRefreshView, pullStatus: $pullStatus, onRefresh: self.onRefresh) {
			self.content()
		}
...
public struct RefreshableListInternal<Content: View>: View {
